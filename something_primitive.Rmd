...
```{r, plotting_one, depends.on="making_numbers_in_secret", echo=F, cache=T, fig.cap="One"}
ggplot(datar)+aes(x=mrna)+geom_histogram(bins=50)
```
...
```{r, this_is_taller, depends.on="making_numbers_in_secret", echo=F, cache=T, fig.cap="Taller. \\label{fig:taller}",fig.height=6}
...
or other ones like number \ref{fig:taller}.
